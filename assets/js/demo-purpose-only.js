...
if ( document.getElementById( "_dm-settingsContainer" ) ) {
    ...
    document.getElementById( "_dm-stickyHeaderCheckbox" ).addEventListener( "change", () => {
    ...
    document.getElementById( "_dm-disableBackdropCheckbox" ).addEventListener( "change", () => {
    ...
    document.getElementById( "_dm-stuckSidebarChekbox" ).addEventListener( "change", () => {
    ...
    document.getElementById( "_dm-uniteSidebarCheckbox" ).addEventListener( "change", () => {
    ...
    document.getElementById( "_dm-pinnedSidebarCheckbox" ).addEventListener( "change", () => {
