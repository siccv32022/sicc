...
<head>
<?php session_start();
echo "<title>OFERTA DE COMPRA #:  ".$_GET['nsap']."</title>"
?>
</head>
...
if($TS=='S') 
  ...
  From      OPQT FA
  Join      PQT1 DF On FA.DocEntry = DF.DocEntry
 ...
 Where FA.DocNum =".$DOC."";}
       ...
       DF.Dscription ART,
       DF.Quantity CANTIDAD,
       (DF.Quantity - DF.OpenCreQty) Cantidad_E,
					...
					<tr height=20%>
						<td width="40%" valign="top">
							<table class="eti">
		        			   ...
		        			   <tr><td>Nombre:</td><td><input type="text" id="cab" size="50" value="'.$row['NOMBRE'].'" disabled></td></tr>
					...
					<tr height=40% valign="top">
						...
						<td colspan=3 style="background-color:#FFFFFF; border: black 1px solid;">
							...
							if($row['TIPO']=='I') 
							{
								...
								<th width="5%">Ctd Ofertada</th>
								<th width="5%">Ctd Pedida</th>
