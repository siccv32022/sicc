...
if($TS=='S') 
  ...
  From      ORDR FA
  Join      RDR1 DF On FA.DocEntry = DF.DocEntry
...
$grid = sqlsrv_query($conn, $query_det, $params);
// sqlsrv_fetch_array
        ...
        $row = sqlsrv_fetch_array($result);
				...
				<table width=100% height=100% >
					<tr height=20%>
						...
						<tr><td>Número:</td><td><input class="form-control" type="text" id="cab" size="30" style="font-size: 10px;" value="'.$row['DOCUMENTO'].'" disabled></td></tr>
					   <tr><td>Fecha de Contabilizacion:</td><td><input class="form-control" type="text" id="cab" style="font-size: 10px;" size="30" value="'.date_format( $row['FECHA_CON'],"d/m/Y").'" disabled></td></tr>
						<tr><td>Fecha de Vencimiento:</td><td><input class="form-control" type="text" style="font-size: 10px;" id="cab" size="30" value="'.date_format( $row['FECHA_VEN'],"d/m/Y").'" disabled></td></tr>
						<tr><td>Fecha de Documento:</td><td><input class="form-control" type="text" style="font-size: 10px;" id="cab" size="30" value="'.date_format( $row['FECHA_DOC'],"d/m/Y").'" disabled></td></tr>
						<tr><td>Número Folio:</td><td><input class="form-control" type="text" id="cab" style="font-size: 10px;" size="30" value="'.$row['NUM_FOL'].'" disabled></td></tr>
					</table>
						</td>
								    ...
								    if($row['TIPO']=='I')
								    	{
											...
											<td>'.number_format(round((int)$row2['Cantidad_E'],4),4).'</td>
											<td>'.number_format(round((int)$row2['Cantidad_P'],4),4).'</td>';
										}
									  else 
									   {
									   	echo '
