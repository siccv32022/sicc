...
if($TS=='S') 
  ...
  From      OPCH FA
  Join      PCH1 DF On FA.DocEntry = DF.DocEntry
 ...
 Where FA.DocNum =?;";}
       ...
       FA.Comments COMENTARIOS
  From      OINV FA
  Join      INV1 DF On FA.DocEntry = DF.DocEntry
  Left Join OSLP EM ON FA.SlpCode = EM.SlpCode
 Where FA.DocNum =?;";
 	   }   
					...
					<tr height=20%>
						...
						<td width="40%" align="right" valign="top">
							<table class="eti">
		        			   ...
		        			   <tr><td>Fecha de Contabilizacion:</td><td><input type="text" id="cab" size="10" value="'.(isset($row['FECHA_CON'])? date_format($row['FECHA_CON'],"d/m/Y"):'').'" disabled></td></tr>
								<tr><td>Fecha de Vencimiento:</td><td><input type="text" id="cab" size="10" value="'.(isset($row['FECHA_VEN'])?date_format($row['FECHA_VEN'],"d/m/Y"):'').'" disabled></td></tr>
								<tr><td>Fecha de Documento:</td><td><input type="text" id="cab" size="10" value="'.(isset($row['FECHA_DOC'])?date_format($row['FECHA_DOC'],"d/m/Y"):'').'" disabled></td></tr>
