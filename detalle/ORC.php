...
<div align="center">
<?php session_start();
$DOC=isset($_GET['nsap'])? $_GET['nsap']:'';
$TS=isset($_GET['tsn'])? $_GET['tsn']:'';
...
if (!$conn) {
  ...
  From      OPOR FA
  Join      POR1 DF On FA.DocEntry = DF.DocEntry
				...
				<table width=100% height=100% >
					...
					<tr height=30%>
						<td width="50%" colspan=2 valign="top">
							<table>
								<tr><td>Comprador:</td><td><input type="text" id="codigo" size="30" value="'.$row['EMPLEADO'].'" disabled></td></tr>
